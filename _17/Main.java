...
public class Main {
    ...
    private static void exercise1() {
        ...
        long myNewLongBankBalanceEuro = myBankBalanceEuro + questionableFundsEuro;
        System.out.println(myNewLongBankBalanceEuro);
    ...
    public static void exercise3()
    {
        ...
        LocalDate newDate = LocalDate.of(2022, 03,11);
        System.out.println(myDate.isBefore(newDate));
